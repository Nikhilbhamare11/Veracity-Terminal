...
export async function generateStaticParams() {
  return [{ category: "business" }, { category: "technology" }, { category: "health" }]
}
...
export default async function CategoryPage({ params }: { params: { category: string } }) {
  ...
  const news = await getTopHeadlines("us", params.category)

  return (
    <div className="container py-8">
      <h1 className="text-3xl font-bold mb-2 capitalize">{params.category} News</h1>
      <p className="text-muted-foreground mb-8">Latest {params.category} headlines</p>
